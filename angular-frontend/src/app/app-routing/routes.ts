...
export const routes: Routes = [
  ...
  { path: 'users/profile', component: ProfileComponent, canActivate: [RoleGuardService],
    data: { expectedRoles: 'USER|ADMIN' }, title: 'My profile - Gatherly' },
  { path: 'users/:id', component: ProfileComponent, canActivate: [RoleGuardService],
    data: { expectedRoles: 'USER|ADMIN' }, title: 'Profile - Gatherly' },
